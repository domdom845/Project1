...
namespace Shopping_List_2
{
    class Frame
    {
        ...
        public void Priority(string value, string category)
        {
            var temp = "";
            var val = value;
            var cat = category;
            ...
            using (MySqlConnection con = new MySqlConnection())
            {
                ...
                string sql = "INSERT INTO shoppinglist (id, productName, category,  priority, dateAdded, purchased) VALUES (@id, @Name,@category, @priority, @dateAdded, @purchased)";
        ...
        public void ListFrame(string value)
        {
            var temp = "";
        ...
        public void sort(char value)
        {
            Console.WriteLine("Enter Item name");
            string str = Console.ReadLine();
        }

        public void purchased(char value)
        {
            Database data = new Database();
        ...
        public string Condition(string value)
        {
            var temp = "";
            if (value == "1")
            {
